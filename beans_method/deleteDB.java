...
public class deleteDB {
	...
	public void deleteComp(campDataBean member) throws Exception {
		...
		try {
			 ...
			 * 
			 * if(rs.next()){ String rId=rs.getString("CompId"); String
			 * rName=rs.getString("CompName");
			 * 
			 * if(CompId.equals(rId) && passwd.equals(rPasswd)){ sql =
			 * "delete from member where id=?"; pstmt = conn.prepareStatement(sql);
	...
	public void delete_rental(int rentalnumber) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		try {
			conn = getConnection(); // DB연결

			String sql = "delete from rental where rentalnumber=? ";
			pstmt = conn.prepareStatement(sql);
	...
	public void delete_request(int rentalnumber) throws Exception {
		Connection conn = null;
		PreparedStatement pstmt = null;
		try {
			conn = getConnection(); // DB연결

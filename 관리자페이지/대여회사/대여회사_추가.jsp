				...
				<form method="post" action="대여회사_추가Pro.jsp" class="validation-form" novalidate >			<!-- 정보 보내는 부분 -->
					<div class="row"> 
						<div class="col-md-6 mb-3"> <label for="nickname">회사 이미지</label> 
							<input type="text" class="form-control" name="IMAGE" value="<%=filename%>"  maxlength=10 readonly> 
					...
					<div class="row"> 
						...
						<div class="col-md-6 mb-3"> 
							...
							<input type="text" class="form-control" name="compCall" placeholder="010-0000-0000" maxlength=13 required> 
					...
					<div class="row"> 
						...
						<div class="col-md-6 mb-3"> 
							...
							<input type="text" class="form-control" name="compManager" placeholder="최대 10자리"  maxlength=10 required> 
						<div class="invalid-feedback"> 비밀번호를 입력해주세요. </div> 
						</div> 
					</div> 									
					<div class="mb-3"> 
						<label for="email">담당자 이메일</label> 
						<input type="email" class="form-control" name="compEmail" placeholder="Hello@Gmail.com" maxlength=254 required> 
					...
					<div class="mb-3"> 
						<input type="hidden" name="compAddress" id="custAddress" /> <!--실질적인 주소 값부분 -->
					</div> 					

...
public class selectDB {
	...
	public ArrayList<campDataBean> selRentBD(String email) throws SQLException {
		...
		try {
			...
			String sql = "select * from v_his where 이메일 = ? order by 대여번호 desc";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1,email);
	...
	public ArrayList<campDataBean> selRentBD() throws SQLException {
		...
		try {
			...
			String sql = "select * from v_his order by 대여번호";
			pstmt = conn.prepareStatement(sql);
	...
	// 대여 내역을 조회하는 메소드
		public ArrayList<campDataBean> selRentBD2() throws SQLException {
			Connection conn = null;
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			...
			try {
				...
				String sql = "select * from v_his order by 대여번호 desc";
				pstmt = conn.prepareStatement(sql);
	...
	public ArrayList<campDataBean> selVRepair(String email) throws SQLException {
		...
		try {
			...
			String sql = "select * from v_repair where 이메일 = ? order by 정비번호 desc";
	...
	public ArrayList<campDataBean> selVRepair() throws SQLException {
		...
		try {
			...
			String sql = "select * from v_repair order by 정비번호";
	...
	// repairinfo와 조인 되는 정비내역 조회하는 메소드
	public ArrayList<campDataBean> selVRepairCheck() throws SQLException {
		...
		try {
			...
			String sql = "select * from v_repairinfo order by 정비번호 desc";
	...
	public ArrayList<campDataBean> selrepairrequest() throws SQLException {
		...
		try {
			...
			String sql = "select repairrequest_num from repairrequest";
			pstmt = conn.prepareStatement(sql);

    ...
    <div class="container">
      ...
      <hr>
      	<form method="post" action="manager4_insert_pro.jsp" class="validation-form" novalidate >			<!-- 정보 보내는 부분 -->
					...
					<div class="row"> 
						<div class="mb-3"> <label for="nickname">정비소ID</label> 
							<input type="text" class="form-control" name="repairShopId" maxlength=10 required> 
						<div class="invalid-feedback"> 정비소ID를 입력해주세요. </div> 
						</div>
					</div> 
					<div class="row"> 

...
%>  
	<tr>
      ...
      <td><%= state %></td>
      <td>
      	<a href="예약처리.jsp?rentalNumber=<%=rentalnumber%>&state=<%=state %>" class="btn btn-primary btn-sm">승인</a>
      ...
      <td>
      	...
      	<a href="예약처리.jsp?rentalNumber=<%=rentalnumber%>&state=<%=state %>" class="btn btn-danger btn-sm">거절</a>
      </td>
      <% } %>
    </tr>
  </tbody> 

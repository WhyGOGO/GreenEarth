 ...
 <div class="container"> 
		<div class="input-form-backgroud row"> 
			<div class="input-form col-md-12 mx-auto"> 
				<h4 class="mb-3">대여 회사 수정하기</h4> <hr>

				<form method="post" action="대여회사_수정Pro.jsp" class="validation-form" novalidate >			<!-- 정보 보내는 부분 -->
					<div class="row"> 
					...
					<hr class="mb-4"> 
					<input type="hidden" name="compId" value="<%=update_comp.getCompId()%>">
					<div class="mb-4"></div> 

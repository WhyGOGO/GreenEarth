     ...
     <div class="app-card" style="width:30%;"> 
		<div class="content-section">
	     <div class="content-section-title">이름 : <%=campcarname%></div>				 
		  ...
		  <div>
			  	대여 시작 : <input type="date" id="RENTALSTART">
			<br>대여 종료 : <input type="date" id="RENTALEND" >
		  </div>
	      </div>	      
	       <div class="app-card-buttons">       
	      	<button class="content-button" id="<%=rentalstatus%>" onclick="btn_alert(this.id,start,end)" >예약</button>
	       </div>	      
      </div>
...
%>  
 ...
 <div class="overlay-app"></div>
    ...
    <script src="../assets/dist/js/bootstrap.bundle.min.js"></script>
  	<script>
  		function btn_alert(clicked_id,start,end){
  			
  			if (clicked_id==1)
  				alert("죄송합니다 고객님! 이 차량은 현재 예약 불가입니다.");
  			else
  				location.href="";		// 결제 창으로 가게 수정해야됨
  		}
  	</script>
  </body>
